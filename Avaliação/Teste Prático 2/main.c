...
/*Executar mais x ciclos depois de se verificar que a matriz convergiu*/
...
int threads_on_wait = 0, iteracao = 0, go_maxD = 1, xcontador = x + 1;
double max_max = 0;
...
void* slaveWork(void* a) {
	...
	/*Calcular valores*/
	for (i = 0; i < iteracoes && xcontador; i++) {
